...
int main(int argc, char** argv)
{
	...
	std::chrono::time_point<std::chrono::system_clock> baseTime = std::chrono::system_clock::now();
	...
	//Check and print total startup time
	newTime = std::chrono::system_clock::now();
	printf("Setup Done in %ims\n",
		std::chrono::duration_cast<std::chrono::milliseconds>(newTime - baseTime).count());
	...
	while (!glfwWindowShouldClose(window)) {
		...
		timeSum += (int)std::chrono::duration_cast<std::chrono::milliseconds>(newTime - baseTime).count();
		frameCount++;
